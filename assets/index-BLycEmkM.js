...
\r
    ...
    <ul class="list-menu">\r
        ...
        <li class="list-menu-item">\r
            <a class="nav-link" href="./about">About</a>\r
        </li>\r
        <li class="list-menu-item">\r
            <a class="nav-link" href="./portfolio">Portfolio</a>\r
        </li>\r
        {{!-- <li class="list-menu-item">\r
            <a class="nav-link" href="./pages">Pages</a>\r
        </li> --}}\r
        <li class="list-menu-item">\r
            <a class="nav-link" href="./blog">Blogs</a>\r
        </li>\r
        <li class="list-menu-item">\r
            <a class="nav-link" href="./contact">Contact</a>\r
        </li>\r
    </ul>\r
